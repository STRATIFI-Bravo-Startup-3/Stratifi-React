...
const Campaigns = () => {
  return (
    <section className="flex flex-col w-full overflow-x-scroll overflow-hidden">
      <h1 className="font-bold text-gray-600 text-lg px-4">Campaigns</h1>
      <div className="bg-gray-200 rounded-lg flex items-center gap-4 justify-around py-8 overflow-hidden overflow-x-scroll">
