      ...
      <div className="flex items-center lg:px-[5rem] p-1  text-gray-100 justify-between xl:mx-auto xl:max-w-7xl max-w-full flex-wrap w-full">
        ...
        >
          <ul className="lg:flex lg:justify-between items-center text-md lg:text-base">
            ...
            <Link href="/login">
              {" "}
              <button className="transition ease-in-out duration-500 delay-150 hover:scale-110 hover:translate-y-1 ml-3 my-3 block text-white px-4 active:bg-[#FF8F50] hover:bg-[#FF7A30] bg-[#FF6610] ring-1 ring-[#FF7A30] shadow-sm shadow-slate-600 rounded">
                Sign in
              </button>
            </Link>
          </ul>
