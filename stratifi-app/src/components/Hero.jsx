    ...
    <section className="w-auto h-[42rem] ">
      ...
      >
        <div className="w-full h-full bg-black opacity-50 absolute top-0 left-0">
          <div className=" flex-col pt-28 px-8 lg:py-36 w-[500px] mx-auto text-left">
            <h1 className="lg:text-6xl text-4xl text-white">COMING SOON...</h1>
            <h1 className="text-2xl mt-5 text-white">
              Get notified when we launch!
            </h1>
            <div className="flex form-input h-10 w-80 mt-5 rounded p-1">
              <input
                className="border-0 p-0 focus:ring-0 w-0 grow"
                type="email"
              />
