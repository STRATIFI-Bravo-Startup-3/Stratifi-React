...
function Faq() {
  ...
  return (
    <section className="faq">
      ...
      <div>
        <div>
          <div className="ask" onClick={toggling}>
            <HiChevronDown />
          ...
          {open && (
            <div className="panel">
              <p>
                Stratifi is an online marketplace for businesses and start-up’s
        ...
        <div>
          ...
          {open && (
            <div className="panel">
              <p>
                An online platform for influencer to connect with brands
                directly
                <br />
                As an influencer we solve the problem of brands not paying for
                the content you promote in the guise of not having enough
                visibility, sales, or ROI. <br /> Connection between brands and
        ...
        <div>
          ...
          {open && (
            <div className="panel">
              <p>
                Signing up as a brand or influencer is completely free, but we
                do charge a commission for every transaction done on stratify
              </p>
            </div>
          )}
        </div>
        ...
        <div>
          ...
          {open && (
            <div className="panel">
              <p>
                At stratify your safety is important to us. Brands and
                influencers must pass our quality assurance checks and must be
                vetted to ensure the safety of each user.
              </p>
            </div>
          )}
        </div>
