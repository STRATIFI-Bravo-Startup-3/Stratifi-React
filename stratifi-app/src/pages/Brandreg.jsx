      ...
      <div className="container">
        <section className="content">
          ...
          <form>
            ...
            <div>
              <label className="choose">Choose a platform</label>
              <br />
              <br />
              <div className="platform">
                <div className="flex platf">
            ...
            <div className="flex">
              <label>Choose type of influencer</label>
          ...
          <div className="form-btn">
            ...
            <button className="btn">Submit my application </button>
          </div>
        </section>
      </div>
    );
